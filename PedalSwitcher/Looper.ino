...
//        midiCC(176,  6,   0);
//        midiCC(176, 38,   1);
        midiOutput1.sendControlChange(99, 125, 1);
        midiOutput1.sendControlChange(98, 88 , 1);
        midiOutput1.sendControlChange(6 , 0  , 1);
        midiOutput1.sendControlChange(38, 1  , 1);
//        midiCC(176, 99, 125);
//        midiCC(176, 98,  88);
//        midiCC(176,  6,   0);
//        midiCC(176, 38,   0);
        ...
        midiOutput1.sendControlChange(98, 88 , 1);
        midiOutput1.sendControlChange(6 , 0  , 1);
        midiOutput1.sendControlChange(38, 0  , 1);
        looperMode = 2;
        prevTime = millis();
...
//        midiCC(176, 38,   1);
        midiOutput1.sendControlChange(99, 125, 1);
        midiOutput1.sendControlChange(98, 89 , 1);
        midiOutput1.sendControlChange(6 , 0  , 1);
        midiOutput1.sendControlChange(38, 1  , 1);
//        midiCC(176, 99, 125);
//        midiCC(176, 98,  89);
